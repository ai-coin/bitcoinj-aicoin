...
public class BlockTest {
  ...
  // aicoin has only a trivial proof of work
//    @Test
...
//    }
  ...
  public void testBlock481829_witnessTransactions() throws Exception {
    ...
    // aicoin figuring out how to create the coinbase transaction for segregated witness
    final Sha256Hash witnessRoot = block481829.getWitnessRoot();
    final Sha256Hash witnessRootHash = Sha256Hash.twiceOf(witnessRoot.getReversedBytes(), witnessReserved);
